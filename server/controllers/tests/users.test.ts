...
describe('user-controller', () => {
  ...
  describe('getUsers function', () => {
    it('should return array of actual users from database', async () => {
      let responseData: [] = [];
  ...
  describe('getDeletedUsers function', () => {
    it('should return array of softly deleted users from database', async () => {
      let responseData: [] = [];
      const response: Partial<Response> = {
        json: jest.fn().mockImplementation((result) => {
          responseData = result;
